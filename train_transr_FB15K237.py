...
for index in range(10):
    result_name = './result/transr_FB15K237_{}.json'.format(index)
    pkg_name = './checkpoint/transr_FB15K237_{}.ckpt'.format(index)
    print(pkg_name)
